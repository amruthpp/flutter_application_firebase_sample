...
import 'package:flutter_application_firebase_sample/view/registration_screen/registration_screen.dart';
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              // Sign in button
              context.watch<LoginScreenController>().onLoading ? CircularProgressIndicator() 
           :   InkWell(
                onTap: () {
                  if (_formKey.currentState!.validate()) {
                      context.read<LoginScreenController>().onLogin(emailAddress: _emailController.text
